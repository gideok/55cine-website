 ...
 * window.TEST_TI_MAGAZINE_SERIAL_DETAIL_CONFIG
 */
(function () {
  var cfg = window.TEST_TI_MAGAZINE_SERIAL_DETAIL_CONFIG || {};
  ...
  var LIST_URL = cfg.listPageUrl || "../magazine-serial-test.html";
  ...
  function renderPrevNext(neighbors) {
    ...
    nav.setAttribute("aria-label", "연재 이동");

    var back = document.createElement("a");
    back.className = "sd-back";
    back.href = LIST_URL;
    back.textContent = "← 연재 목록";
    nav.appendChild(back);

    var cols = document.createElement("div");
    cols.className = "sd-pn-cols";
    cols.setAttribute("aria-label", "이전·다음 연재");
  ...
  function renderArticle(article) {
    ...
    if (article.coverImage) {
      ...
      coverWrap.className = "sd-cover-wrap sd-cover--serial";
