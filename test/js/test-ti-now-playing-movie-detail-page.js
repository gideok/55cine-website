 ...
 * SEO 경로: test/movies/now-playing/{slug}.html (파일명 = slug)
 * window.TEST_TI_MOVIE_DETAIL_CONFIG
 */
(function () {
  var cfg = window.TEST_TI_MOVIE_DETAIL_CONFIG || {};
  ...
  function getMovieSlug() {
    ...
    if (file === "movie-detail.html") return "";
